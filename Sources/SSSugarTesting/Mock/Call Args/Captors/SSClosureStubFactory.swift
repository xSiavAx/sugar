...
public final class SSClosureStubFactory {
    ...
    public static func it<Arg1, Arg2, Arg3, Arg4, Ret>() -> (Arg1, Arg2, Arg3, Arg4) -> Ret {
        let closure: (Arg1, Arg2, Arg3, Arg4) -> Ret = { _, _, _, _ in return () as! Ret }
        return closure
    }
    ...
    public static func it<Arg1, Arg2, Arg3, Arg4, Arg5, Ret>() -> (Arg1, Arg2, Arg3, Arg4, Arg5) -> Ret {
        let closure: (Arg1, Arg2, Arg3, Arg4, Arg5) -> Ret = { _, _, _, _, _ in return () as! Ret }
        return closure
    }
}
